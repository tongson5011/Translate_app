...
################################################################################
# Form generated from reading UI file 'interfaceZdYkTK.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_8.addWidget(
            self.label_2, 0, Qt.AlignLeft | Qt.AlignTop)
        ...
        self.horizontalLayout_8.addWidget(
            self.label_3, 0, Qt.AlignLeft | Qt.AlignTop)
        ...
        self.page.setGeometry(QRect(0, 0, 196, 234))
        ...
        icon = QIcon()
        icon.addFile(u":/icons/icons/alert-triangle.svg",
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/bar-chart-2.svg",
                      QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.page_2.setGeometry(QRect(0, 0, 196, 234))
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/printer.svg",
                      QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/phone-incoming.svg",
                      QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/icons/align-left.svg",
                      QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.horizontalLayout_7.addWidget(
            self.open_close_side_bar_btn, 0, Qt.AlignLeft | Qt.AlignTop)
        ...
        self.verticalLayout_11.addWidget(
            self.label_5, 0, Qt.AlignHCenter | Qt.AlignBottom)
        ...
        self.verticalLayout_11.addWidget(
            self.label_6, 0, Qt.AlignHCenter | Qt.AlignTop)

        self.scrollArea = QScrollArea(self.main_body_contents)
        ...
        self.scrollArea.setStyleSheet(u"QScrollArea{\n"
                                      ...
                                      "	border-image:url(:/icons/icons/feather/chevrons-down.svg);\n"
                                      "}\n"
                                      "\n"
                                      "QScro"
                                      ...
                                      "	subcontrol-origin: margin;\n"
                                      "	border-image:url(:/icons/icons/feather/chevrons-right.svg);\n"
                                      "}\n"
                                      "\n"
                                      ...
                                      "	subcontrol-origin: margin;\n"
                                      "	border-image:url(:/icons/icons/feather/chevrons-up.svg);\n"
                                      "}\n"
                                      "\n"
                                      ...
                                      "	subcontrol-origin: margin;\n"
                                      "	border-image:url(:/icons/icons/feather/chevrons-left.svg);\n"
                                      "}\n"
                                      "\n"
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 546, 226))
        ...
        self.label_9.setPixmap(QPixmap(u":/icons/icons/film.svg"))
        ...
        self.label_11.setPixmap(QPixmap(u":/icons/icons/share-2.svg"))
        ...
        self.label_13.setPixmap(QPixmap(u":/icons/icons/cast.svg"))
        ...
        self.label_15.setPixmap(QPixmap(u":/icons/icons/award.svg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_12.setText(
            QCoreApplication.translate("MainWindow", u"ITEM 3", None))
        self.toolBox.setItemText(self.toolBox.indexOf(
            self.page), QCoreApplication.translate("MainWindow", u"Drop Menu 1", None))
        self.pushButton_13.setText(
            QCoreApplication.translate("MainWindow", u"SUB MENU", None))
        self.pushButton_14.setText(
            QCoreApplication.translate("MainWindow", u"SUB MENU", None))
        self.label_4.setText(QCoreApplication.translate(
            "MainWindow", u"Some text you would like to fill here", None))
        self.toolBox.setItemText(self.toolBox.indexOf(
            self.page_2), QCoreApplication.translate("MainWindow", u"Drop Menu 2", None))
